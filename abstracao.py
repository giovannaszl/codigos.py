...
A idéia é trabalhar no nível mais genérico e deixar que as classes mais
específicas implementem os detalhes.
...
class Pessoa(ABC):
    ...
    @abstractmethod
    def apresentar(self): # Méteodo abstrato (obrigatório para as filhas)
        pass
